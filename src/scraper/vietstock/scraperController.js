 ...
 * @description Orchestrates scraping of company profiles from
 * finance.vietstock.vn and exports one pivoted CSV per stock group
...
/**
 * Main controller for the finance.vietstock.vn scraper.
