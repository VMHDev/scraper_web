/**
 * @file commons.js
 * @description URL builders for the tcinvest.tcbs.com.vn evaluation scraper.
 */
const {
  SCRAPER_TYPE_STOCKS,
...
/**
 * Builds the list of TCBS evaluation pages to scrape for a stock group.
 ...
 * @param {string} type - One of SCRAPER_TYPE_STOCKS.
 * @returns {string} Path like `src/data/tcbs-evaluation-<type>-<timestamp>.csv`.
 */
